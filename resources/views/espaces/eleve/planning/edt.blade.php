                                ...
                                <div class="row full-calendar">
                                    <div class="col-md-12">
                                        <div class="row m-b-lg">
                                            <center>
                                                <div class="col-lg-6 m-t-md"><span class="label label-primary">Cours disponibles - Cahier de charge non rempli.</span></div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Titre</label>
                                    <input class="form-control" disabled v-model="selectedEvent.titre" type="text" placeholder="Titre">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Contenu</label>
                                    <textarea disabled class="form-control" v-model="selectedEvent.contenu" name="" id="" cols="30" rows="4" placeholder="Contenu"></textarea>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <div class="be-checkbox">
                                    {{--<input id="check2" disabled type="checkbox" v-model="has_dm">--}}
                            ...
                            <div class="col-lg-12" v-if="has_dm">
                                <div class="form-group" >
                                    ...
                                    <input type="date" disabled class="form-control" v-model="dm.echeance">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12" v-if="has_dm">
                                <div class="form-group">
                                    ...
                                    <textarea v-model="dm.desc" disabled class="form-control" name="" id="" cols="30" rows="4" placeholder="Contenu"></textarea>
                                </div>
                            </div>
