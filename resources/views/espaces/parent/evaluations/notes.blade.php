...
//           $.fn.select2.defaults.set( "theme", "bootstrap" );
    ...
    <template type="text\template" id="notes">
        <div>
            <div class="col-lg-8">
                <div class="panel panel-default panel-border-color panel-border-color-primary coll">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <div class="col-lg-4">
                                <div class=""><label class="control-label">Eleve</label></div>
                                <div class="">
                                    <select id="select2-eleve" class="select2">
                                        <option :value="null" disabled selected  >Selectionner un élève</option>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-4">
                                <div class="btn-toolbar">
                                    ...
                                    <div role="" class="">
                                        <a href="#" @click="reload" class="btn-xl btn  btn-default" data-toggle="tooltip" data-placement="top" title="Recharger les données"><i class="icon mdi mdi-refresh"></i>Recharger</a>
            ...
            <div class="col-sm-12" >
                <div class="panel panel-default" v-show="evals.length!=0">
                    <div class="panel-heading">

                    </div>
                    <div class="panel-body">
                        <h4 class="center">Liste des evaluations</h4>
                        <br>
                        <div id="divConteneur">
                        <table  class="table table-condensed table-hover table-bordered table-striped" v-show="ready">
                            <thead>
                            <tr>
                                <th>Evaluations</th>
                                <th>Notes</th>
                            ...
                            <tbody>
                            <tr v-for="eval in evals">
                                <td>@{{ moment(eval.date).format('DD MMM YYYY') }}</td>
                                <td>@{{ eval.notes[0].note }}</td>
                            </tr>
                            <tr>
                                <td><b>Moyenne</b></td>
                                <td><b>@{{ moyCalc(evals) }}</b></td>
                            </tr>
                            </tbody>
