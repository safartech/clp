                        ...
                        <div class="col-lg-6">
                            <div class="btn-toolbar">
                                ...
                                <div  class="" role="group">
                                    ...
                                    {{--<a href="#" class="btn-xl btn btn-defaultX " title="Popover on top" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><i class="icon mdi mdi-print"></i></a>--}}
                                    {{--<a href="#" class="btn-xl btn btn-defaultX " data-toggle="tooltip" data-placement="top" title="Imprimer emploi du temps"><i class="icon mdi mdi-print"></i></a>--}}
                                    {{--<a href="#" class="btn-xl btn btn-defaultX " data-toggle="tooltip" data-placement="top" title="Programmer un cours" @click="showCoursCreatorModal"><i class="icon mdi mdi-plus"></i></a>--}}
                                    {{--<a href="#" class="btn-xl btn  btn-defaultX active " data-toggle="tooltip" data-placement="top" title="Option inactive"><i class="icon mdi mdi-settings"></i></a>--}}
                                    {{--<a href="#" class="btn-xl btn  btn-defaultX active tooltipped" ><i class="icon mdi mdi-settings"></i></a>--}}
                                </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class="table table-condensed table-hover table-bordered ">
                                        ...
                                        <tr v-for="h in horaires">
                                            ...
                                            <td class="text-center index" :class="hooveredTd(jour,h)" v-for="jour in jours" v-show="isWeekend(jour)" @click="showCoursUpdatorModal(jour,h)" :style="{ 'background-color': getCoursMatiereColor(jour,h) }">
