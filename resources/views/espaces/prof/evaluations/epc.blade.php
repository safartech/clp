...
//           $.fn.select2.defaults.set( "theme", "bootstrap" );
    ...
    <template type="text\template" id="epc">
        <div>
            ...
            <div id="evaluationModal1" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-success">
            ...
            <div id="evaluationModal2" tabindex="-1" role="dialog" class="modal fade colored-header colored-header-success">
                <div class="modal-dialog custom-width">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" data-dismiss="modal" aria-hidden="true" class="close md-close"><span class="mdi mdi-close"></span></button>
    ...
    <script type="module" src="{{ asset('js/vues/prof/evaluations/epc.js') }}"></script>
@endsection
