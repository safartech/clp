                                ...
                                <div class="col-lg-3">
                                    <div class="btn-toolbar">
                                        ...
                                        <div  class="" role="group">
                                            ...
                                            {{--<a href="#" class="btn-xl btn btn-default btn-warning" data-toggle="tooltip" data-placement="top" title="Conseils de classe" @click="showConseilSetter()" v-show="showBulletin"><i class="icon mdi mdi-layers" ></i></a>--}}
                                            <a :href="bullLink" target="_blank" class="btn-xl btn btn-default btn-default" data-toggle="tooltip" data-placement="top" title="Imprimer bulletin" v-show="showBulletin"><i class="icon mdi mdi-print"></i></a>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default" v-show="showBulletin">
                        <div class="panel-heading">
                            Bulletin <b>@{{ getEleveName() }}</b>
                            <span class="primary">Moyenne Trimesrielle</span> <b class=" label" style="font-size: 2em;color: darkred">@{{ moyEleve() }}</b>
                            {{--<span class="primary">Moyenne de la classe</span> <b class="label" style="font-size: 2em;color: darkred">@{{ moyenne_de_la_classe }}</b>--}}
