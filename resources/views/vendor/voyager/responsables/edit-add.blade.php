        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                          class="form-edit-add"
                          action="@if(!is_null($dataTypeContent->getKey())){{ route('responsables.update', $dataTypeContent->getKey()) }}@else{{ route('responsables.store') }}@endif"
                            ...
                            <!-- GET THE DISPLAY OPTIONS -->
                                ...
                                @else
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ isset($display_options->width) ? $display_options->width : 12 }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        {{ $row->slugify }}
                                        <label for="name">{{ $row->display_name }}@if($row->required == 1) <span style="color: red;">*</span> @endif</label>
