...
<div class="container">
    <div class="col s12">
        <div class="">
            ...
            <h5><u>Session:</u> <b>{{ $session->nom }}</b> </h5>
            <h5><u>Classe:</u>  <b>{{ $classe->nom }}</b></h5>
            <h5><u>Effectif:</u>  <b>{{ sizeof($eleves) }}</b></h5>
            <h5><u>Matiere:</u> <b>{{ $sm->matiere->intitule }}</b> </h5>
            <h5><u>Sous-matiere:</u> <b>{{ $sm->nom }}</b> </h5>
            {{--<h5>Module: </h5>--}}
        </div>
        <h3 class="text-center"><u>Releve de Note: <b>{{ $sm->nom }}</b> <i>({{ $session->nom }})</i></u></h3>
