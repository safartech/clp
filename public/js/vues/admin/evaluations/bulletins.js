...
let bulletins = {
    ...
    methods:{
        ...
        validate(){
            ...
            let c = this.conseils.find(x=>x.eleve_id==this.selectedEleve.id && x.session_id==this.selectedSession.id)
            if(!c){
                this.conseils.push(this.selectedEleveConseil)
            }
        ...
        getMoyByMat(matiere){
            // console.log("mat",matiere.id)
            // console.log("selectedClasse",this.selectedClasseId)
            // console.log("selectedClasse",this.selectedSessionId)
            let evalsOfClass = []
